...
- **premium_recon / loss_recon**: split the break further (add covg_type_desc, pol_yr, tx_type_nm); check whether a whole segment is missing (presence) or scaled (constant ratio), and whether the pipeline or SOT side moved.
